...
export default function DashboardPage() {
  ...
  const { data, loading, refetch } = useQuery(GET_SESSION_ANALYTICS, {
    variables: {
  ...
  return (
    <div className="p-6 bg-gray-200 shadow-3xl rounded-2xl min-h-screen text-white">
      ...
      <div className="grid lg:grid-cols-2 gap-6 mb-8">
        <div className=" p-5 rounded-xl">
          <h2 className="font-semibold text-black text-lg mb-4">Calls Analytics</h2>
        ...
        <div className=" p-5 rounded-xl">
          <h2 className="font-semibold text-black text-lg mb-4">Chats Analytics</h2>
      ...
      <div className="bg-[#2c0a4d] p-5 rounded-xl">
        <h2 className="font-semibold text-lg mb-4">All Session Status</h2>

    
        <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4 mb-8">
          {statusCards.map((card) => (
            <div
              className="bg-white rounded-3xl p-4 shadow text-center"
              key={card.title}
            >
      ...
      <div className="bg-violet-900 p-5 mt-10 rounded-xl">
