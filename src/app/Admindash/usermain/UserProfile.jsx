...
import { GET_USER_PROFILE } from "@/app/graphQL/astroHiring";
...
<Info
  ...
  value={
    user?.stats?.totalRechargeCount || 0
  }
/>
...
<Info
  label="Last Recharge"
  value={`₹${
    user?.stats?.lastRechargeAmount || 0
  }`}
/>
