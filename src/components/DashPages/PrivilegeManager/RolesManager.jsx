...
import { CREATE_ROLE, DELETE_ROLE, GET_ROLES, UPDATE_ROLE } from "@/app/graphQL/privilageOperations";
  ...
  const { permissions } = usePermissions();
    ...
    return (
        <div className="p-10 space-y-5">
            ...
            {canCreateRole &&
                <button onClick={() => { resetForm(); setOpenModal(true); }} className="px-5 py-2 bg-yellow-500 text-black rounded-lg">
                    Create Role
                </button>
            }
